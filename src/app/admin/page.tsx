        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-indigo-100/80 text-indigo-700 border border-indigo-200">
              Supabase PostgreSQL & Prisma Live
            </span>
            <span className="text-xs text-slate-500 font-medium">Master Evaluation Console</span>
          </div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Ph.D Examination Control Board</h1>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-slate-500">Review syllabi, question counts, and proctoring parameters</p>
          </div>
          <Link
            href="/admin/exams"
